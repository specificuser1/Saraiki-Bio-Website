...
## 🎨 Video Background Kaise Add Karein / How to Add Video Background

### Option 1: Admin Panel Se (Easy)
1. Admin panel kholen (`admin.php`)
2. Login karein (Username: `admin`, Password: `admin123`)
3. Niche "Upload Files" section mein jayein
4. "Background Video (MP4)" select karein
5. Apna video file choose karein aur upload karein

### Option 2: Manual Upload
1. Apna video file ko `background.mp4` naam dein
2. Railway ya FTP se upload karein same folder mein jahan `index.php` hai
